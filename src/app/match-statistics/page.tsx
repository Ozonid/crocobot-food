...
import type { PlayerStatistics } from '@/types/Data'
import Table, { Column, SortCol, ColumnValue } from '@/components/Table'
import { getMatchStatistics } from '@/utils/getMatchStatistics'
import { formatMoney } from '@/utils/dataFormatters'
...
const MoneyChart = dynamic(() => import('@/app/match-statistics/MoneyChart'), {
  ssr: false,
})
